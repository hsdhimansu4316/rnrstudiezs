                ...
                <div className="row">
                    <div className="col-md-6 d-flex justify-content-center align-items-center" style={{ minHeight: "400px" }}>
                        <div className="counselling-section">
                            <div className="counselling-banner">Clarity in Thought, Confidence in Action</div>
                            <div className="counselling-content">
                                {/* <h2 className="text-white"></h2> */}
                                <h2 className="text-white text-left">One to One Counselling Session For Personalized Guidance from the Experts</h2>
                                <ul className="counselling-list">
                                    <li className="text-white">➤ Get Exam and Top B-School Counseling</li>
                                    <li className="text-white">➤ Know About The Job prospects after an MBA</li>
                                    <li className="text-white">➤ Strategies to Ace Top Management Exam</li>
                                </ul>
